<template>
  <div>
    <el-button id="create" type="primary" size="small" @click="createFormVisible = true">新增菜单</el-button>
    <el-table id="table" :data="pageData.records" style="width: 100%">
      <el-table-column prop="id" label="序号" width="50"/>
      <el-table-column prop="name" label="名称" width="100"/>
      <el-table-column prop="path" label="地址" width="auto"/>
    ...
    <el-dialog v-model="createFormVisible" title="新增" align-center>
      <el-form :model="createForm">
        ...
        <el-form-item label="地址" :label-width="180">
          <el-input v-model="createForm.path" autocomplete="off"/>
        </el-form-item>
...
import {page, update, save, destroy} from '../apis/menu.ts'
